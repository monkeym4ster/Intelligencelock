...
import com.ziroom.developer.string.StringUtil;
					...
					if (field.getType().getSimpleName().equals("Date")) {
						if (field.getName().toLowerCase().startsWith("begin")) {
							...
							if (beginName.isEmpty()) {
								...
								Criteria criteria = dateMap.get(beginName) == null
										? Criteria.where(beginName).gte(value)
										: dateMap.get(beginName).gte(value);
						...
						if (field.getName().toLowerCase().startsWith("end")) {
							...
							if (endName.isEmpty()) {
								...
								Criteria criteria = dateMap.get(endName) == null
										? Criteria.where(endName).lt(value)
